...
if __name__ == '__main__':
    ...
    parser.add_argument('--d_hub', type=int, default=1, help='number of hub tokens, one is enough')
    # --- RevIN Params ---
    ...
    parser.add_argument('--pct_start', type=float, default=0.3, help='learning rate adjustment start percentage')
    ...
    parser.add_argument('--itransformer_factor', type=int, default=1, help='attention factor')
    # DLinear
    parser.add_argument('--individual', action='store_true', default=False, help='DLinear: a linear layer for each variate(channel) individually')
    # Crossformer
    parser.add_argument('--seg_len', type=int, default=12, help='segment length')
    ...
    data_info = {
        ...
        'solar': {'data_path': 'solar_AL.txt', 'enc_in': 137, 'freq': 'h'},
